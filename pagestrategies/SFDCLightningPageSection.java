...
@PageSectionLocatorStrategy(title="SF Page Section",  // Name that will uniquely identify strategy file in TB 
sectionName ="{label} PageSection",// Default name for the block that is displayed while mapping in TB, {label} will get replaced with actual label value
